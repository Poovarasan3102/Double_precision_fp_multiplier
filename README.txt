...
2. Enter into the cad_for_vlsi directory  #cd cad_for_vlsi
...
5. To test the corner cases with tb.bsv make the following change in th Makefile in the cad_for_vlsi directory and then execute the 3rd step
   TOPFILE   = tb.bsv
   TOPMODULE = mktester
6. To test the flag cases with tb_flag.bsv make the following change in th Makefile in the cad_for_vlsi directory and then execute the 3rd step
   TOPFILE   = tb_flag.bsv
